    ...
    <div className="space-y-6">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/50 backdrop-blur-sm overflow-y-auto">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl overflow-hidden my-8 flex flex-col max-h-[90vh]">
            <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center bg-gray-50 shrink-0">
              ...
              <div className="flex items-center gap-4">
                ...
                <button 
                  ...
                  disabled={isScanning}
                  className="inline-flex items-center gap-2 rounded-md bg-gradient-to-r from-purple-600 to-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:from-purple-500 hover:to-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 disabled:opacity-50"
                >
                  {isScanning ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label htmlFor="name" className="block text-sm font-medium text-gray-700 flex justify-between">
                      ...
                      {aiConfidenceInfo?.productName === 'uncertain' && <span className="text-xs text-amber-600 bg-amber-50 px-1 rounded">Uncertain</span>}
                    </label>
                  ...
                  <div>
                    <label htmlFor="purchase_cost" className="block text-sm font-medium text-gray-700 flex justify-between">
                      ...
                      {aiConfidenceInfo?.purchaseCost === 'uncertain' && <span className="text-xs text-amber-600 bg-amber-50 px-1 rounded">Uncertain</span>}
                    </label>
                  ...
                  <div>
                    <label htmlFor="batch_number" className="block text-sm font-medium text-gray-700 flex justify-between">
                      ...
                      {aiConfidenceInfo?.batchNumber === 'uncertain' && <span className="text-xs text-amber-600 bg-amber-50 px-1 rounded">Uncertain</span>}
                    </label>
                  ...
                  <div>
                    <label htmlFor="manufacturing_date" className="block text-sm font-medium text-gray-700 flex justify-between">
                      <span>Mfg Date</span>
                      {aiConfidenceInfo?.manufacturingDate === 'uncertain' && <span className="text-xs text-amber-600 bg-amber-50 px-1 rounded">Uncertain</span>}
                    </label>
                  ...
                  <div>
                    <label htmlFor="expiry_date" className="block text-sm font-medium text-gray-700 flex justify-between">
                      ...
                      {aiConfidenceInfo?.expiryDate === 'uncertain' && <span className="text-xs text-amber-600 bg-amber-50 px-1 rounded">Uncertain</span>}
                    </label>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="col-span-full">
                        <label htmlFor="item_size" className="block text-sm font-medium text-gray-700 flex justify-between">
                          <span>Item Size *</span>
                          {aiConfidenceInfo?.measurement === 'uncertain' && <span className="text-xs text-amber-600 bg-amber-50 px-1 rounded">Uncertain</span>}
                        </label>
                      ...
                      {packagingType !== 'NONE' && (
                        <div>
                          <label htmlFor="units_per_pack" className="block text-sm font-medium text-gray-700 flex justify-between">
                            ...
                            {aiConfidenceInfo?.unitsPerPack === 'uncertain' && <span className="text-xs text-amber-600 bg-amber-50 px-1 rounded">Uncertain</span>}
                          </label>
                          <input 
                            type="number" 
                            min="1" 
...
fs.writeFileSync(path.join(process.cwd(), 'web/src/app/dashboard/products/ProductsClient.tsx'), content);
console.log('ProductsClient rewritten successfully.');
