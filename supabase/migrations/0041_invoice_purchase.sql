-- Migration 0041: Atomic Invoice Purchase with Product Creation

CREATE OR REPLACE FUNCTION public.process_invoice_purchase(
    p_store_id UUID,
    p_supplier_id UUID,
    p_idempotency_key UUID,
    p_items JSONB -- Array of { is_new: boolean, variant_id: UUID, product_name: text, category_id: UUID, sku: text, barcode: text, purchase_cost: numeric, quantity: integer, attributes: jsonb }
)
RETURNS UUID
LANGUAGE plpgsql
SECURITY DEFINER
        ...
        LOOP
            ...
            IF v_is_new THEN
                ...
                INSERT INTO public.product_variants (
                    ...
                    v_product_id, v_org_id, v_sku, v_barcode, v_attributes, v_cost, v_cost, true
                ...
                INSERT INTO public.variant_price_history (
                    ...
                    v_org_id, v_variant_id, v_cost, v_cost
                );
            ELSE
